...
async function fetchPost(id) {
    try {
        ...
        showPopup("We hit a wall!", `<div class='image-text-container'><img src='images/firewall.png'></img><div>There was an error fetching this post, maybe it's ID is invalid or your network state was changed while loading... Anyways, try again later!<br>${error}</div></div>`, () => {
